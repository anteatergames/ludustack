...
namespace LuduStack.Domain.Core.Enums
{
    public enum GameElement
    {
        ...
        [UiInfo(Display = "2D Character", Type = (int)BillRateType.Visual)]
        [Display(Name = "2D Character")]
        Character2d = 2,

        [UiInfo(Display = "2D Asset", Type = (int)BillRateType.Visual)]
        [Display(Name = "2D Asset")]
        Asset2d = 3,

        [UiInfo(Display = "2D Level Design", Type = (int)BillRateType.Visual)]
        [Display(Name = "2D Level Design")]
        Level2d = 4,

        [UiInfo(Display = "3D Character", Type = (int)BillRateType.Visual)]
        [Display(Name = "3D Character")]
        Character3d = 5,

        [UiInfo(Display = "3D Asset", Type = (int)BillRateType.Visual)]
        [Display(Name = "3D Asset")]
        Asset3d = 6,

        [UiInfo(Display = "3D Level Design", Type = (int)BillRateType.Visual)]

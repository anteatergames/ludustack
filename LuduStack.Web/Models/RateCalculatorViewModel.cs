...
namespace LuduStack.Web.Models
{
    public class RateCalculatorViewModel
    {
        ...
        [Required]
        [Display(Name = "Annual Cost", Description = "The amount of money needed to survive each year only paying the bills and buying food.")]
        [Range(1, double.MaxValue, ErrorMessage = "Need a number here!")]
        ...
        [Display(Name = "per month", Description = "The amount of money needed for unplanned expenses each month")]
        public double SavingsValueMonthly { get; set; }

        [Display(Name = "per year", Description = "The amount of money needed for unplanned expenses each year")]
        ...
        [Required]
        [Display(Name = "Taxes %", Description = "The percentage of money you must pay as taxes of your country/state/city. Choose a value between 25%-40% according to where you live.")]
        [Range(0, double.MaxValue, ErrorMessage = "Need a number here!")]
        public double TaxesPercentage { get; set; }

        [Display(Name = "per month", Description = "The amount of money for taxes per month.")]
        public double TaxesValueMontly { get; set; }

        [Display(Name = "per year", Description = "The amount of money for taxes per year.")]
        ...
        [Required]
        [Display(Name = "Rush Factor", Description = "The percentage to add to a rushed job. If the client want you to deliver fast, they must understand the overrate. We recommend a number between 50%-100%.")]
        [Range(0, double.MaxValue, ErrorMessage = "Need a number here!")]

...
namespace LuduStack.Web.Models
{
    public class MvcExternalLoginViewModel : ExternalLoginViewModel
    {
        ...
        [RegularExpression("^(?=.{3,64}$)(?![_.-])(?!.*[_.-]{2})[a-zA-Z0-9._-]+(?<![_.-])$", ErrorMessage = "Must have minimum 3 characters.</br>Must contain only letters, numbers, dashes, underscores and dots.</br>Must not contain two symbols in sequence.</br>Must not start or end with a symbol.</br>Must not contain spaces.")]
